...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.BiMC.PHASE2.VISUAL_PROTO_MODE = 'original'
    cfg.TRAINER.BiMC.PHASE2.TEXT_PROTO_MODE = 'original'
    cfg.TRAINER.BiMC.PHASE2.DYNAMIC_LAMBDA_I = False
    cfg.TRAINER.BiMC.PHASE2.DYNAMIC_LAMBDA_MAX = 0.95
    cfg.TRAINER.BiMC.PHASE2.VISUAL_SHRINKAGE = 0.1
    cfg.TRAINER.BiMC.PHASE2.TEXT_REWEIGHT_TAU = 10.0
    cfg.TRAINER.BiMC.PHASE2.TEXT_COMBINE_WEIGHT = 0.5

    cfg.TRAINER.BiMC.PHASE3 = CN()
    cfg.TRAINER.BiMC.PHASE3.ENABLED = False
    cfg.TRAINER.BiMC.PHASE3.TEMP_SCALING_ENABLED = False
    cfg.TRAINER.BiMC.PHASE3.TEMP_VALUE = 1.0
    ...
    cfg.TRAINER.BiMC.PHASE3.DYNAMIC_ALPHA_NOVEL_ONLY = False
    ...
    cfg.TRAINER.BiMC.PHASE3.HUBNESS_SOURCE = 'support'
    cfg.TRAINER.BiMC.PHASE3.HUBNESS_STRENGTH = 0.1

    cfg.TRAINER.BiMC.PHASE4 = CN()
    cfg.TRAINER.BiMC.PHASE4.ENABLED = False
    cfg.TRAINER.BiMC.PHASE4.COV_MODE = 'original'
    cfg.TRAINER.BiMC.PHASE4.APPLY_TO_NOVEL = False
    cfg.TRAINER.BiMC.PHASE4.REPLACE_NOVEL_NN = False
    cfg.TRAINER.BiMC.PHASE4.NOVEL_AUX_COMBINE_MODE = 'average'
    cfg.TRAINER.BiMC.PHASE4.COV_SCORE_WEIGHT = 0.5
    cfg.TRAINER.BiMC.PHASE4.HYBRID_DIAG_WEIGHT = 0.5
    cfg.TRAINER.BiMC.PHASE4.EPS = 1e-4
    ...
    cfg.TRAINER.BiMC.PHASE5.STRENGTH = 1.0
    cfg.TRAINER.BiMC.PHASE5.EPS = 1e-6

    cfg.TRAINER.BiMC.PHASE6 = CN()
    cfg.TRAINER.BiMC.PHASE6.ENABLED = False
    cfg.TRAINER.BiMC.PHASE6.ALIGNMENT_MODE = 'none'
    cfg.TRAINER.BiMC.PHASE6.ALIGNMENT_STRENGTH = 0.25
    cfg.TRAINER.BiMC.PHASE6.OT_TAU = 10.0
    cfg.TRAINER.BiMC.PHASE6.LABEL_PRIOR_ENABLED = False
    cfg.TRAINER.BiMC.PHASE6.LABEL_PRIOR_TRANSDUCTIVE = False
    cfg.TRAINER.BiMC.PHASE6.LABEL_PRIOR_STRENGTH = 0.25

    cfg.TRAINER.BiMC.PHASE7 = CN()
    cfg.TRAINER.BiMC.PHASE7.ENABLED = False
    cfg.TRAINER.BiMC.PHASE7.SEPARATION_MODE = 'none'
    cfg.TRAINER.BiMC.PHASE7.SEPARATION_STRENGTH = 0.15
    cfg.TRAINER.BiMC.PHASE7.GRAPH_K = 5
